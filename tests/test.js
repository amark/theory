...
('test',function(a){
	var testit = (function(z,x,y){
		...
		test('[1,2,3,4,5,6,7,8,9], 2', 2, theory.list([1,2,3,4,5,6,7,8,9]).at(2));
		test('[1,2,3,4,5,6,7,8,9], 2', 2, theory.list.at([1,2,3,4,5,6,7,8,9],2));
		test('[1,2,3,4,5,6,7,8,9], -2', 8, theory.list([1,2,3,4,5,6,7,8,9]).at(-2));
		test('[1,2,3,4,5,6,7,8,9], -2', 8, theory.list.at([1,2,3,4,5,6,7,8,9],-2));
		test('[1,2], 9', undefined, theory.list([1,2]).at(9));
		test('[1,2], 9', undefined, theory.list.at([1,2],9));
		
		state("theory.list( TEST ) || .ebb( TEST )");
		test('[2,3,4], 2', 3, theory.list([2,3,4]).ebb(2));
		test('[2,3,4], 2', 3, theory.list.ebb([2,3,4],2));
		test('[2,3,4], -2', 3, theory.list([2,3,4]).ebb(-2));
		test('[2,3,4], -2', 3, theory.list.ebb([2,3,4],-2));
		test('[2,3,4], 9', 4, theory.list([2,3,4]).ebb(9));
		test('[2,3,4], 9', 4, theory.list.ebb([2,3,4],9));
		test('[2,3,4], -9', 2, theory.list([2,3,4]).ebb(-9));
		test('[2,3,4], -9', 2, theory.list.ebb([2,3,4],-9));
		test('[2,3,0], 9', 0, theory.list([2,3,0]).ebb(9));
		test('[2,3,0], 9', 0, theory.list.ebb([2,3,0],9));
		test('[false,3,4], -9', false, theory.list([false,3,4]).ebb(-9));
		test('[false,3,4], -9', false, theory.list.ebb([false,3,4],-9));
		...
		test('"1,2,3 ; 4,5,6",{split:\';\'}', ["1,2,3","4,5,6"], theory.list("1,2,3 ; 4,5,6").ify({split:';'}));
		test('"1,2,3 ; 4,5,6",{split:\';\'}', ["1,2,3","4,5,6"], theory.list.ify("1,2,3 ; 4,5,6",{split:';'}));
		...
		test("{a:1,b:'c',d:[0,1,2]},{split:'='}", ['a=1','b=c','d=0,1,2'], theory.list({a:1,b:'c',d:[0,1,2]}).ify({wedge:'='}));
		test("{a:1,b:'c',d:[0,1,2]},{split:'='}", ['a=1','b=c','d=0,1,2'], theory.list.ify({a:1,b:'c',d:[0,1,2]},{wedge:'='}));
		
		state("theory.list( TEST ) || .fuse( TEST )");
		test('[2,3],[4,5],[6,7]', [2,3,4,5,6,7], theory.list([2,3]).fuse([4,5],[6,7]));
		test('[2,3],[4,5],[6,7]', [2,3,4,5,6,7], theory.list.fuse([2,3],[4,5],[6,7]));
